// Generated on 2015-12-06 using generator-angular-fullstack 3.0.0
'use strict';
  ...
  grunt.initConfig({
    ...
    babel: {
      ...
      client: {
        files: [{
          expand: true,
          cwd: '<%= yeoman.client %>',
          src: ['{app,components,assets}/**/!(*.spec).js'],
          dest: '.tmp'
        }]
      },
      server: {
    ...
    injector: {
      ...
      scripts: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
               [
                 '.tmp/{app,components,assets}/**/!(*.spec|*.mock).js',
      ...
      css: {
        ...
        files: {
          '<%= yeoman.client %>/index.html': [
            '<%= yeoman.client %>/{app,components,assets,bower_components/font-awesome/css/}/**/*.css'
